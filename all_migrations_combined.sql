...
-- ===== Next migration: 001_initial_schema.sql =====
...
-- ===== Next migration: 002_pipelines_enhancements.sql =====
...
-- ===== Next migration: 003_broadcast_recipient_wamid.sql =====
...
-- ===== Next migration: 004_contact_delete_set_null.sql =====
...
-- ===== Next migration: 005_broadcast_counts_incremental.sql =====
...
-- ===== Next migration: 006_automations.sql =====
...
-- ===== Next migration: 007_automations_increment_counter.sql =====
...
-- ===== Next migration: 008_profile_avatars_storage.sql =====
...
-- ===== Next migration: 009_message_actions.sql =====
...
-- ===== Next migration: 011_profile_beta_features.sql =====
...
-- ===== Next migration: 012_flows_increment_counter.sql =====
...
-- ===== Next migration: 013_whatsapp_config_phone_number_id_unique.sql =====
...
-- ===== Next migration: 014_message_templates_meta_integration.sql =====

-- ============================================================
-- 015_message_templates_account_unique.sql
-- ------------------------------------------------------------
-- Adjust the unique index for message_templates from (user_id, name, language)
-- to (account_id, name, language) to support true multiâ€‘tenant isolation.
--
-- Steps:
...
--   4. Update any dependent fk constraints â€“ none exist currently.
...
BEGIN
  ...
  IF dupe_count > 0 THEN
    ...
    RAISE EXCEPTION
      E'Cannot add UNIQUE(account_id, name, language) on message_templates â€” % duplicate combination(s):\n  %\nDelete the rows you do not want to keep, then re-run migrations.',
      dupe_count, sample;
  END IF;
END $$;
...
-- ===== Next migration: 015_message_templates_account_unique.sql =====
...
-- ===== Next migration: 015_whatsapp_config_registration.sql =====
...
-- ===== Next migration: 016_flow_media.sql =====
...
-- ===== Next migration: 017_account_sharing.sql =====
...
-- ===== Next migration: 018_account_member_rpcs.sql =====
...
-- ===== Next migration: 019_invitation_rpcs.sql =====
...
-- ===== Next migration: 020_account_sharing_followups.sql =====
...
-- ===== Next migration: 021_account_default_currency.sql =====
...
-- ===== Next migration: 022_contact_phone_dedup.sql =====
...
-- ===== Next migration: 023_chat_media.sql =====
...
-- ===== Next migration: 024_member_presence.sql =====
...
-- ===== Next migration: 025_filter_contacts_by_tags.sql =====
...
-- ===== Next migration: 026_api_keys.sql =====
