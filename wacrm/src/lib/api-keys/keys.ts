...
//
// Why the `vbuild_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a Vbuild CRM key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `vbuild_test_` variant if
...
export const API_KEY_PREFIX = 'vbuild_live_';
