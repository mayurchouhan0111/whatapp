...
const tiers = [
  {
    ...
    features: ["1 user", "500 contacts", "500 conversations/mo", "100 broadcasts/mo", "1 WhatsApp number", "WhatsApp Store — not included"],
    cta: "Get Started",
    href: "/signup",
    highlighted: false,
  },
  {
    ...
    features: ["3 agents", "5,000 contacts", "5,000 conversations/mo", "1,000 broadcasts/mo", "WhatsApp Store (20 products)", "Flows & Automations"],
  ...
  },
  {
    ...
    features: ["10 agents", "50,000 contacts", "50,000 conversations/mo", "10,000 broadcasts/mo", "WhatsApp Store (150 products)", "3 WhatsApp numbers", "API access", "Priority support"],
    cta: "Start Free Trial",
    href: "/signup",
    highlighted: false,
  },
